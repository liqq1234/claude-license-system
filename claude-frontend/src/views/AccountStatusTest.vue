            ...
            <div v-else class="accounts-grid">
                ...
                >
                    <div class="account-header">
                        ...
                        >{{ getStatusText(account.status) }}</div>
                    </div>
                    ...
                    <div
                        v-if="account.status === 'busy' && account.recoverySeconds"
                        class="recovery-timer"
                    >恢复倒计时: {{ formatTime(account.recoverySeconds) }}</div>
...
const stats = computed(() => {
    ...
    const stats = accounts.value.reduce(
        (acc, account) => {
